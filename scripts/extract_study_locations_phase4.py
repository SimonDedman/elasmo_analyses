...
This script extracts geographic information about WHERE the research was conducted
(study location) as opposed to WHERE the authors are based (author institution).

This enables "parachute research" analysis: comparing author country vs study country.
...
COUNTRIES = {
    'USA': ['united states', 'u.s.a', 'usa', 'u.s.', 'california', 'florida',
            'hawaii', 'gulf of mexico', 'chesapeake', 'mississippi', 'texas',
            'alaska', 'georgia', 'carolina', 'virginia', 'delaware'],
    ...
    'Mexico': ['mexico', 'mexican', 'baja', 'gulf of california', 'sea of cortez'],
    ...
    'Italy': ['italy', 'italian', 'mediterranean', 'adriatic'],
...
def main():
    ...
    print("\n" + "="*80)
    print("PHASE 4: EXTRACT STUDY LOCATIONS FROM METHODS SECTIONS")
    print("="*80 + "\n")
