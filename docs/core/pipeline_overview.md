...
<!-- Generated by scripts/report_corpus_stats.py on 2026-09-23. Do not hand-edit. -->

| Metric | Value | Notes |
|--------|------:|-------|
| Papers catalogued | 31,772 | rows in the enriched parquet |
| Parquet columns | 1,747 | all families plus metadata |
| PDF files on disk | 21,253 | raw count; over-counts supplements and duplicates |
| Evidence rows | 260,734 | audit trail across 17,867 papers |
...
| RAG index | 19,801 papers / 203,731 chunks | `outputs/rag/build_status.json` |
| Conference abstracts | 23,408 | 7,784 chondrichthyan, 123 meetings |
...
- **Evidence rows fell on 2026-09-23, and that is the fix, not a loss.** The
  extractor used to resolve a paper's PDF from (first author, year), which paired
  1,471 papers with another paper's text. It now resolves through
